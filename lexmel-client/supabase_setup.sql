...
('M6',  'Alertas, Recordatorios y Notificaciones',  '2026-07-13', '2026-08-11', 'Sin iniciar', 10, 4, 'Crear los módulos para informar al usuario de las acciones del sistema.', 'Recordatorios, Notificaciones, Alertas, Notificaciones por correo'),
('M7',  'Visualización, Cartera y Timeline',  '2026-08-12', '2026-09-04', 'Sin iniciar', 15, 3, 'Integrar funciones complementarias y globales para completar la plataforma.', 'Dashboard de widgets, Cartera, Timeline de juicio, Comentarios del juicio'),
