...
('M7',  'Visualización, Cartera y Timeline (MVP)',  '2026-08-10', '2026-09-04', 'Sin iniciar', 15, 4, 'Integrar funciones complementarias y globales para completar la plataforma.', 'Dashboard de widgets, Cartera, Timeline de juicio, Comentarios del juicio'),
('M8',  'MBI 1.0',                                 '2026-09-07', '2026-10-09', 'Sin iniciar', 10, 5, 'Módulos adicionales al sistema para complementar el funcionamiento del MVP.', 'Chat, Solicitudes de cambio, Dictámenes'),
